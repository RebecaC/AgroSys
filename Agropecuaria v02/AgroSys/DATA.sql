...
CREATE TABLE `detalle_pedido_cliente` (
  `id_detalle_pedido_cliente` int(11) NOT NULL AUTO_INCREMENT,
  `cantidad` int(11) DEFAULT NULL,
  `pedido_cliente_id_pedido_cliente` int(11) NOT NULL,
  `producto_id_producto` int(11) NOT NULL,
  PRIMARY KEY (`id_detalle_pedido_cliente`,`pedido_cliente_id_pedido_cliente`,`producto_id_producto`),
  KEY `fk_detalle_pedido_cliente_pedido_cliente1_idx` (`pedido_cliente_id_pedido_cliente`),
  KEY `fk_detalle_pedido_cliente_producto1_idx` (`producto_id_producto`),
  CONSTRAINT `fk_detalle_pedido_cliente_pedido_cliente1` FOREIGN KEY (`pedido_cliente_id_pedido_cliente`) REFERENCES `pedido_cliente` (`id_pedido_cliente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_detalle_pedido_cliente_producto1` FOREIGN KEY (`producto_id_producto`) REFERENCES `producto` (`id_producto`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=ucs2 COLLATE=ucs2_spanish_ci;

/*Data for the table `detalle_pedido_cliente` */
...
/*Table structure for table `envio_cliente` */

DROP TABLE IF EXISTS `envio_cliente`;

CREATE TABLE `envio_cliente` (
  `id_envio_cliente` int(11) NOT NULL AUTO_INCREMENT,
  `fecha` date DEFAULT NULL,
  `hora` time DEFAULT NULL,
  `cliente_id_cliente` int(11) NOT NULL,
  PRIMARY KEY (`id_envio_cliente`,`cliente_id_cliente`),
  KEY `fk_envio_cliente_cliente1_idx` (`cliente_id_cliente`),
  CONSTRAINT `fk_envio_cliente_cliente1` FOREIGN KEY (`cliente_id_cliente`) REFERENCES `cliente` (`id_cliente`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=ucs2 COLLATE=ucs2_spanish_ci;

/*Data for the table `envio_cliente` */
...
CREATE TABLE `factura` (
  ...
  `cliente_id_cliente` int(11) NOT NULL,
  `pedido_cliente_id_pedido_cliente` int(11) NOT NULL,
  `pedido_cliente_cliente_id_cliente` int(11) NOT NULL,
  ...
  KEY `fk_factura_pedido_cliente1_idx` (`pedido_cliente_id_pedido_cliente`,`pedido_cliente_cliente_id_cliente`),
  ...
  CONSTRAINT `fk_factura_pedido_cliente1` FOREIGN KEY (`pedido_cliente_id_pedido_cliente`, `pedido_cliente_cliente_id_cliente`) REFERENCES `pedido_cliente` (`id_pedido_cliente`, `cliente_id_cliente`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=ucs2 COLLATE=ucs2_spanish_ci;
