...
namespace AgroSys {
    ...
    public partial class Proveedor : global::System.Data.DataSet {
        ...
        public partial class proveedorDataTable : global::System.Data.TypedTableBase<proveedorRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public proveedorRow AddproveedorRow(string nombre_proveedor) {
...
namespace AgroSys.ProveedorTableAdapters {
    ...
    public partial class proveedorTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `proveedor` WHERE ((`id_proveedor` = @Original_id_proveedor) AND ((@I" +
                "sNull_nombre_proveedor = 1 AND `nombre_proveedor` IS NULL) OR (`nombre_proveedor" +
                "` = @Original_nombre_proveedor)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `proveedor` (`nombre_proveedor`) VALUES (@nombre_proveedor)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `proveedor` SET `nombre_proveedor` = @nombre_proveedor WHERE ((`id_proveed" +
                "or` = @Original_id_proveedor) AND ((@IsNull_nombre_proveedor = 1 AND `nombre_pro" +
                "veedor` IS NULL) OR (`nombre_proveedor` = @Original_nombre_proveedor)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `id_proveedor`, `nombre_proveedor` FROM `proveedor`";
        ...
        public virtual int Fill(Proveedor.proveedorDataTable dataTable) {
        ...
        public virtual Proveedor.proveedorDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Proveedor.proveedorDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Proveedor dataSet) {
        ...
        public virtual int Delete(int Original_id_proveedor, string Original_nombre_proveedor) {
        ...
        public virtual int Update(string nombre_proveedor, int Original_id_proveedor, string Original_nombre_proveedor) {
            if ((nombre_proveedor == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(Original_id_proveedor));
            if ((Original_nombre_proveedor == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Original_nombre_proveedor));
            }
